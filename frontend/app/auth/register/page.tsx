...
import type { RegisterFormData } from '@/src/utils/validation';
import { useRegister } from '@/src/hooks/register';

const Register: React.FC = () => {
  const { handleRegister, isSubmitting, errors } = useRegister();
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.subheading}>Start your paper trading journey today</div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.row}>
            <div style={styles.field}>
              ...
              {errors.firstName && <span style={styles.fieldError}>{errors.firstName}</span>}
            </div>
            ...
            <div style={styles.field}>
              ...
              {errors.lastName && <span style={styles.fieldError}>{errors.lastName}</span>}
            </div>
          </div>
